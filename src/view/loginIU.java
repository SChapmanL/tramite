...
public class loginIU extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(255, 247, 237));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (pass.equals(contra) && user.equals(usuario)) {
            VentanaTramiteIU VT = new VentanaTramiteIU();
            VT.setVisible(true);
            dispose();
        }
        else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginIU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
